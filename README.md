...
**Materials and Cost**
 ...
 - [DHT22 Sensor Module (Pack of 2)](https://www.amazon.com/HiLetgo-Temperature-Humidity-Electronic-Practice/dp/B0795F19W6/ref=sxin_3_ac_d_rm?ac_md=0-0-ZGh0MjI%3D-ac_d_rm&cv_ct_cx=DHT22&keywords=DHT22&pd_rd_i=B0795F19W6&pd_rd_r=d65bd0ca-803c-467a-8fe2-0597b67ca3ba&pd_rd_w=XHpWI&pd_rd_wg=S5hdr&pf_rd_p=6d29ef56-fc35-411a-8a8e-7114f01518f7&pf_rd_r=XM4XC7BMJBMDD1AS9GYK&qid=1578954825&th=1): $11
 ...
 - [Soldering Iron and Solder](https://www.amazon.com/Soldering-Kit-Temperature-Desoldering-Electronics/dp/B07XKZVG8Z/ref=sr_1_9?keywords=soldering+iron&qid=1580765871&sr=8-9): $10

 **Total: $96** -- At time of publication.
...
**Note 3:** If you are a scientist who is not well versed in these topics and already feels overwhelmed, don't worry, this documentation has you covered. Similarly, if you are already familiar with this material, feel free to ignore me and do your own thing. These instructions will always be here if you need them, and I'm happy to answer any questions and/or update with tips and tricks other people know/come up with!
...
4) Understanding the Gmail API and Declaring Environmental Variables
...
Next, logout of the default pi user and into the new one that you just made. Again, open a terminal window, this time typing:

`sudo userdel -r pi`

This will not only delete the default account, it also removes the associated home folder as well.
...
Finally, I should mention that the script is set-up, initially, to pretend as if a single sensor is really four. This sounds way more confusing than it actually is; it is simply a proof of concept by way of software modeling, and is done by creating four variables with the same reference pin, but different target temperature ranges. Remember to change these reference pins as needed, and be sure to start with only a single sensor if you don't, otherwise you will receive some very confusing results.

## Understanding the Gmail API and Declaring Environmental Variables
...
**Alternatively, navigate to the `system` folder in the specified location and drop in the `service` file included in the repository.** Then, open a terminal window and skip ahead to the "Verifying Start on Boot" section.
